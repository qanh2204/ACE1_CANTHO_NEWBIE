			...
			<div class="row">
				...
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					<div
						...
						<p class="frst-desc">Contrary to popular belief, Lorem Ipsum
						...
						<ul class="addr-info">
							<li>
								<div class="if-item">
									...
									<p class="dsc">01, Ly Tu Trong Street, Ninh District Kieu,
										TP. Can Tho</p>
								</div>
							</li>
							<li>
								<div class="if-item">
									<b class="tie">Phone:</b>
									<p class="dsc">(+84) 123 123 123</p>
								</div>
							</li>
							<li>
								<div class="if-item">
									<b class="tie">Email:</b>
									<p class="dsc">1987SecondHand@company.com</p>
								</div>
							</li>
							<li>
								<div class="if-item">
									<b class="tie">Store Open:</b>
									<p class="dsc">7 Days a week from 10:00 am</p>
								</div>
							</li>
						</ul>
