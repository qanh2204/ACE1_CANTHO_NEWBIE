						...
						<div class="top-functions-area">
							<div class="flt-item">
								<div class="checkout-act active">
									<h3 class="title-box">Payment info</h3>
									<div class="box-content">
										<p class="txt-desc">Enter complete information to proceed with payment</p>
											...
											<form action="${path}/save-check-out" id="frmCheckOut" method="post">
												...
												<div class="col-12">
													<label for="">Phone</label> <input
														...
														id="txtPhone" placeholder="Enter phone">
												</div>
												</p>
												<p class="form-row">
												<div>
				...
				<div
					...
					<div class="order-summary sm-margin-bottom-80px">
						<div class="title-block">
							<h3>Receipt</h3>
							<a href="#" class="link-forward">Back to cart</a>
						</div>
						<div class="cart-list-box short-type">
							<span class="number">${numberProducts} Products</span>
							<ul class="cart-list">
											...
											<div class="price price-contain">
												<ins>
													<span class="price-amount"><fmt:formatNumber
															...
															value="${item.product.price}" /> <u>$</u></span>
												</ins>
											</div>
										</div>
									</li>
							...
							<ul class="subtotal">
								<li>
									<div class="subtotal-line">
										<b class="stt-name">Total:</b> <span class="stt-price"><fmt:formatNumber
												type="number" groupingUsed="true" value="${total}" /> <u>$</u></span>
									</div>
								</li>
