...
<title>1987 Second Hand - Master home</title>
<!--     Fonts and icons     -->
<link
	...
	<aside
		...
		<div class="sidenav-header">
			<i
				...
				href="${path}/master"> <img src="../assets/images/organic-4.png"
                  ...
                  <g transform="translate(-1716.000000, -439.000000)"
                    ...
                    <g transform="translate(1716.000000, 291.000000)">
                      <g transform="translate(0.000000, 148.000000)">
						...
						</div> <span class="nav-link-text ms-1">Home Page</span>
				</a></li>
                  ...
                  <g transform="translate(-1869.000000, -293.000000)"
                    ...
                    <g transform="translate(1716.000000, 291.000000)">
                      <g id="office"
						...
						</div> <span class="nav-link-text ms-1">Statistical</span>
				</a></li>
				<li class="nav-item"><a class="nav-link  " href="#">
						<div
							class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                  ...
                  <g transform="translate(-2169.000000, -745.000000)"
                    ...
                    <g transform="translate(1716.000000, 291.000000)">
                      <g transform="translate(453.000000, 454.000000)">
						...
						</div> <span class="nav-link-text ms-1">Bill</span>
				</a></li>
                  ...
                  <g transform="translate(-2319.000000, -291.000000)"
                    ...
                    <g transform="translate(1716.000000, 291.000000)">
                      <g transform="translate(603.000000, 0.000000)">
						...
						</div> <span class="nav-link-text ms-1">Manufacturer</span>
				</a></li>
				<li class="nav-item"><a class="nav-link  "
					href="${path}/payments">
						<div
                  ...
                  <g transform="translate(-2319.000000, -291.000000)"
                    ...
                    <g transform="translate(1716.000000, 291.000000)">
                      <g transform="translate(603.000000, 0.000000)">
						...
						</div> <span class="nav-link-text ms-1">Payments</span>
				</a></li>				
				...
				<ul class="navbar-nav  justify-content-end">
					<li class="nav-item d-flex align-items-center"><a href="#"
						...
						class="nav-link text-body font-weight-bold px-0"> <i
							class="fa fa-user me-sm-1"></i> <span class="d-sm-inline d-none">${name}</span>
					</a></li>
					...
					<li class="nav-item px-3 d-flex align-items-center"><a
						href="${path}/master/logout" class="nav-link text-body p-0"> <i
							class="fa fa-sign-out fixed-plugin-button-nav cursor-pointer"></i>
					</a></li>
				</ul>
			</div>
		</div>
	</nav>
	<!-- End Navbar --> <!-- Body --> <jsp:include page="${body}" /> <!-- Footer -->
			...
			<div class="row align-items-center justify-content-lg-between">
				<div class="col-lg-6 mb-lg-0 mb-4">
					<div class="copyright text-center text-sm text-muted text-lg-start">
						...
						, made with <i class="fa fa-heart"></i> by 1987 Second Hand.
					</div>
				</div>
			</div>
		</div>
