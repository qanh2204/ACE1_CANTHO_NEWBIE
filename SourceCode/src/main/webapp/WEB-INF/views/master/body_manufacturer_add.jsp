			...
			<div class="card mb-4">
				...
				<div class="card-body ">
					<div class="p-0 align-items-center mb-0">
						<form:form action="${path}/manufacturers/postAdd" method="POST"
							modelAttribute="manufacturerAdd" id="frmManufacturer" role="form">
							<label>Manufacturer Name</label>
							<div class="mb-3">
								<form:input path="name" id="txtName" type="text"
									class="form-control" placeholder="Manufacturer" aria-label="Name"
