			...
			<div class="card mb-4">
				...
				<div class="card-body ">
					<div class="p-0 align-items-center mb-0">
						<form:form action="${path}/products/postAdd" method="POST"
							modelAttribute="productAdd" id="frmProduct" role="form">
							<label>Product's name</label>
							<div class="mb-3">
								<form:input path="name" id="txtName" type="text"
									class="form-control" placeholder="Product" aria-label="Name"
							...
							<div class="mb-3">
								<form:select path="tblCategory" id="txtCategory"
							...
							<div class="mb-3">
								<form:select path="tblManufacturer" id="txtManufacturer"
