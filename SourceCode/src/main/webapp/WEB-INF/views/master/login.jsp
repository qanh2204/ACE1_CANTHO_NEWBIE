...
<title>1987 Second Hand master - Sign in</title>
<!--     Fonts and icons     -->
<link
				...
				<nav
					...
					<div class="container-fluid pe-0">
						<a class="navbar-brand font-weight-bolder ms-lg-0 ms-3 " href="${path}/master_login">
							<img src="../assets/images/organic-4.png" 
							width="135" height="70">
						</a>
					</div>
				</nav>
							...
							<div class="card card-plain mt-8">
								<div class="card-header pb-0 text-left bg-transparent">
									<h3 class="font-weight-bolder text-info text-gradient">Welcome
										back</h3>
									<p class="mb-0">Please enter your account and password to login</p>
								</div>
									...
									<form:form action="${path}/master_login/save" method="POST"
										...
										<div class="text-center">
											<form:button type="button" id="btnSubmit"
												class="btn bg-gradient-info w-100 mt-4 mb-0">Login</form:button>
										</div>
									</form:form>
								</div>
							</div>
	...
	<footer class="footer py-5">
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-8 mx-auto text-center mb-4 mt-2">PHAM THANH
					DUY - DUYPT11</div>
