		...
		<div class="col-12">
			<div class="card mb-4">
				<div class="card-header pb-0">
					<h6>List of product images (${productName})</h6>
				...
				<div class="card-body px-0 pt-0 pb-2 row">
					<div class="col-4 px-5 py-2">
						<form:form action="${path}/images-product/postAdd" method="POST"
							...
							<label>Add an image for the product <img
							...
							<div class="center">
								<button type="button" id="btnSubmit"
									class="btn bg-gradient-info w-100 mt-4 mb-0">Add</button>
							</div>
						</form:form>
					</div>
					<div class="col-8">
						<table class="table table-responsive align-items-center mb-0"
							...
							<thead>
								<tr>
									<th
										class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Image code</th>
									<th
										class=" text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Product picture</th>
